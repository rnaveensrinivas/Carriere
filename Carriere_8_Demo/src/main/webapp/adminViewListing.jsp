			...
			<div class="card" style='width: 18rem; margin: 20px; float: left'>
				<div class="card border-dark mb-3" style='text-align: center;'>
					...
					<div class="card-footer">
						<a href="adminEditJob.jsp?id=<%=j.getId()%>" class="btn btn-light"
							style="background-color: black; color: white; border: none;">Edit</a>
						<a href="adminViewJob.jsp?id=<%=j.getId()%>" class="btn btn-light"
